// =========================================
// ไฟล์: script.js (เวอร์ชัน Pro - Success Popup & Badge Limit)
// =========================================
...
const missions = [
    ...
    { 
        ...
        answer: ["include", "main", "var_3", "printf_ask_age", "scanf_age", "printf_ask_weight", "scanf_weight", "printf_ask_blood", "scanf_blood", "printf_health", "printf_show_age_only", "printf_show_weight", "printf_show_blood", "return"], 
...
// อัปเดตให้แสดงแค่แบดจ์จากด่านล่าสุดที่ผ่าน
...
function runCode() {
    ...
    if(userSequence === currentCorrectAnswer) {
        ...
        // เตรียมข้อความสำหรับ Popup ยินดีด้วย
        ...
        // โชว์ Popup ถ้านักเรียนทำสำเร็จ
